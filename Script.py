...
"""
    ...
    ABOUT_TXT = """<b>🤖 ᴍʏ ɴᴀᴍᴇ : <a href=>ᴍᴏᴠɪᴇs ғɪʟᴛᴇʀ ʙᴏᴛ</a>
👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href=>sʜᴀʀᴀᴛʜ</a>
📝 ʟᴀɴɢᴜᴀɢᴇ : ᴘʏʀᴏɢʀᴀᴍ
📚 ꜰʀᴀᴍᴇᴡᴏʀᴋ : ᴘʏᴛʜᴏɴ 3
📡 ʜᴏsᴛᴇᴅ ᴏɴ : ғʀᴇᴇ ʜᴏsᴛɪɴɢ
📢 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : <a href=>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
...
- 100﹪ Cᴏᴅᴇᴅ Bʏ <a href=>sʜᴀʀᴀᴛʜ</a>

- & Rᴇᴩᴏ Lɪɴᴋ 👇 Hᴇʀᴇ"""

    SOURCE_TXT = """Tʜɪs Is Aɴ Oᴩᴇɴ-Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ Bʏ @Tamilan_BotsZ</b>

- 100﹪ Cᴏᴅᴇᴅ Bʏ <a href=>sʜᴀʀᴀᴛʜ</a></b>
